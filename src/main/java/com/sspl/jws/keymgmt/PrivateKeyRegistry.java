...
public class PrivateKeyRegistry 
{
	...
	private static Map<String, String> privateKeyRegistryMap = new HashMap<String, String>();
	
	static
	{
		privateKeyRegistryMap.put(keyIdFIPOne, rsaJsonWebKeySetAsStrFIPOne);
	}
	
	public static PrivateKey getPrivateKey(String keyId) throws Exception
	{
		String rsaJsonWebKeySetAsStr = privateKeyRegistryMap.get(keyId);
